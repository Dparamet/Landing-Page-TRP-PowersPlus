...
export default function Services() {
  ...
  return (
    <section id="services" className="section-reveal bg-white py-20">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <div key={service.title} className="reveal-item rounded-lg border border-slate-200 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-[#f08a24] hover:shadow-lg hover:shadow-slate-100">
